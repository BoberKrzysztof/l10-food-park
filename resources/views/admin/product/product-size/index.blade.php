                            ...
                            <tbody>
                                @foreach ($sizes as $size)
                                    <tr>
                                        ...
                                        <td>{{ $size->price }}</td>
                                        <td>
                                            <a href="{{ route('admin.product-size.destroy', $size->id) }}" class='btn btn-danger delete-item mx-2'>
                            ...
                            <tbody>
                                @foreach ($options as $option)
                                    <tr>
                                        ...
                                        <td>{{ $option->price }}</td>
                                        <td>
                                            <a href="{{ route('admin.product-option.destroy', $option->id) }}" class='btn btn-danger delete-item mx-2'>
                                                <i class='fas fa-trash'></i>
                                            </a>
                                        </td>
                                    </tr>
