                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-md-right">
                                <address>
                                    ...
                                    @else
                                        <span class="badge badge-warning">{{ strtoupper($order->order_status) }}</span>
                                    @endif
                                </address>
                            </div>
                        </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-4 text-right">
                                    ...
                                    <div class="invoice-detail-item">
                                        ...
                                        <div class="invoice-detail-value invoice-detail-value-lg">{{ currencyPosition($order->grand_total) }}
                                    </div>
                                </div>
                            </div>
                        </div>
