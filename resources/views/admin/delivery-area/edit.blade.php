                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="min_delivery_time" value="{{ $area->min_delivery_time }}" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="max_delivery_time" value="{{ $area->max_delivery_time }}" />
                        </div>
                    </div>
