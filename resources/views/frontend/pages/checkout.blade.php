                                                    ...
                                                    <form action="{{ route('address.store') }}" method="POST">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div style="display: flex">
                                                                <button style="width: 200px;" type="button" class="common_btn cancel_new_address mr-2">cancel</button>
                                                                <button style="width: 200px;" type="submit" class="common_btn mx-2">save address</button>
                                                            </div>
                                ...
                                @foreach ($addresses as $address)
                                    <div class="col-md-6">
                                        <div class="fp__checkout_single_address">
                                            <div class="form-check">
                                                <input class="form-check-input v_address" value="{{ $address->id }}" type="radio" name="flexRadioDefault" id="home-{{ $address->id }}">
                                                <label class="form-check-label" for="home-{{ $address->id }}">
                                                    @if ($address->type === 'home')
                                                        <span class="icon"><i class="fas fa-home"></i> home</span>
                                                    @else
                                                        <span class="icon"><i class="fas fa-car-building"></i> office</span>
                                                    @endif
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.v_address').on('click', function(){
                ...
                $.ajax({
                    method: 'GET',
                    url: '{{ route("checkoute.delivery-cal", ":id") }}'.replace(":id", addressId),
                    beforeSend: function(){
                        showLoader();
                    },
