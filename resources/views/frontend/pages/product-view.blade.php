            ...
            <div class="row">
                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-duration="1s">
                    <div class="fp__menu_details_text">
                        ...
                        <form id="v_add_to_cart_form" action="">
                            @csrf
                                ...
                                <div class="details_size">
                                    ...
                                    @foreach ($product->productSizes as $productSize)
                                        <div class="form-check">
                                            <input class="form-check-input v_product_size" type="radio" name="product_size" id="size-{{ $productSize->id }}" data-price="{{ $productSize->price }}" value="{{ $productSize->id }}" />
                            ...
                            @if ($product->productOptions()->exists())
                                <div class="details_extra_item">
                                    ...
                                    @foreach ($product->productOptions as $productOption)
                                        <div class="form-check">
                                            <input class="form-check-input v_product_option" name="product_option[]" type="checkbox" value="{{ $productOption->id }}" id="option-{{ $productOption->id }}" data-price="{{ $productOption->price }}" />
...
@push('scripts')
    <script>
        $(document).ready(function(){
            ...
            // Funcion to update the total price base on selected options
            ...
            $("#v_add_to_cart_form").on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    beforeSend: function(){
                        ...
                        $('.v_submit_button').html('<span class="spinner-border spinner-border-sm text-light" aria-hidden="true"></span> Loading...');
                    },
